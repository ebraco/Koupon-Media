...
function register_button($buttons) {
   array_push($buttons, "heading","big_heading","boc_button", "checklist","highlight","boc_tooltip","accordion","tabs","big_title","feat_text","feat_text_aqua","testimonials","posts_carousel","portfolio_carousel","slider","counters","counter_circles","clients_section","table","price_table","message","person","icon","border", "youtube","vimeo");    
   return $buttons;
}
